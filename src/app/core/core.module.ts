 ...
 *
 *Do put a singleton service whose instance will be shared throughout the application in the CoreModule (e.g. UserService).
 *
 *Do import all modules required by the assets in the CoreModule (e.g. CommonModule or FormsModule).
 *
 ...
 *
 *Do gather application-wide, single use components in the CoreModule. Import it once (in the AppModule) when the app starts and never import it anywhere else. (e.g. TitleComponent).
 *
